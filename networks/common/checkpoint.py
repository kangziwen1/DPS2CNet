...
def load_double(model, optimizer, scheduler, resume, path, logger):
  '''
  ...
  if not resume:
    ...
    model.module.weights_init() # https://blog.csdn.net/qq_43332629/article/details/125322182
    epoch = 1
    return model, optimizer, scheduler, epoch

  # If resume, check that path exists and load everything to return
  else:
    file_path = '/home/ubuntu/log/kzw/base_double/chkpt/best-metric/weights_epoch_028.pth'
