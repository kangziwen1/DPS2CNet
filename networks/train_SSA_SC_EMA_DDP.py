...
# CUDA_VISIBLE_DEVICES="0,1" python -m torch.distributed.launch --nproc_per_node 2 /home/ubuntu/Code/gyf/BIN_Geo_Loss/networks/train_SSA_SC_EMA_DDP.py
...
def parse_args():
    ...
    parser.add_argument(
        '--cfg',
        dest='config_file',
        default='/home/ubuntu/Code/gyf/BIN_Geo_Loss/SSC_configs/examples/SSA_SC_MREF.yaml',
        metavar='FILE',
...
def train(model, optimizer, scheduler, dataset, _cfg, start_epoch, logger, tbwriter,args):
    ...
    model.SSCNet.set_device(args.local_rank)
    ...
    # model.SSCNet.set_epoch_num(epoch)
