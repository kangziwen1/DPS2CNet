...
def parse_args():
    ...
    parser.add_argument(
        '--cfg',
        dest='config_file',
        default='/home/qq/code/gyf/SSA-SC-MREF/SSC_configs/examples/SSA_SC_MREF.yaml',
        metavar='FILE',
    ...
    parser.add_argument(
        '--dset_root',
        dest='dataset_root',
        default='/media/qq/0CBE052B0CBE052B/dataset/SemanticKITTIRare/',
        metavar='DATASET',
...
def main(flag):
    ...
    model = checkpoint.load_model(model,'/media/qq/0B980F580B980F58/SSC_OUT/SSA_SC_SemanticKITTI_MREF_Rare/chkpt/best-metric/weights_epoch_026.pth',logger)
