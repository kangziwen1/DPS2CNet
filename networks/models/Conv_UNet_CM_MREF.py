...
class BEV_UNet_Convnext(nn.Module):
    def __init__(self, n_class, n_height, dilation, bilinear, group_conv, input_batch_norm, dropout, circular_padding,
        ...
        self.down1 = down_convnext(self.encoder,1,LayerNorm(128,data_format="channels_first").cuda())
        self.down2 = down_convnext(self.encoder,2,LayerNorm(256,data_format="channels_first").cuda())
        self.down3 = down_convnext(self.encoder,3,LayerNorm(512,data_format="channels_first").cuda())
        self.down4 = down_convnext(self.encoder,4,LayerNorm(512,data_format="channels_first").cuda())
