...
class ResContextBlock(nn.Module):
    def __init__(self, in_filters, out_filters, kernel_size=(3, 3, 3), stride=1, indice_key=None):
        ...
        self.bn0 = norm_func(out_filters)
        self.act1 = act_func(True)
        ...
        self.bn0_2 = norm_func(out_filters)
        self.act1_2 = act_func(True)

        self.conv2 = conv3x1(in_filters, out_filters, indice_key=indice_key + "bef3")
        self.act2 = act_func(True)
        self.bn1 = norm_func(out_filters)
        ...
        self.act3 = act_func(True)
        self.bn2 = norm_func(out_filters)
...
class UpBlock(nn.Module):
    def __init__(self, in_filters, out_filters, kernel_size=(3, 3, 3), indice_key=None, up_key=None):
        ...
        self.trans_act = act_func(True)
        self.trans_bn = norm_func(out_filters)
        ...
        self.act3 = act_func(True)
        self.bn3 = norm_func(out_filters)
...
class ReconBlock(nn.Module):
    def __init__(self, in_filters, out_filters, kernel_size=(3, 3, 3), stride=1, indice_key=None):
        ...
        self.bn0_3 = norm_func(out_filters)
...
class Asymm_3d_spconv(nn.Module):
    def __init__(self,
        ...
        #
        # self.logits = spconv.SubMConv3d(4 * init_size, self.nclasses, indice_key="logit", kernel_size=3, stride=1,
        #                                 padding=1,
        #                                 bias=True)
