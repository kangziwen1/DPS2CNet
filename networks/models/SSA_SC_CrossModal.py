...
class SSA_SC_CM(nn.Module):
    ...
    def forward(self, x, stat='train'):
        ...
        # ============================ Run Through ImageEncode Network ============================
        img_encode = self.ImageEncoder(x['2D_RGB'])
        # ============================ Run Through Completion Network ============================
        x = self.SSCNet(out_data, x_ds1, x_ds2, x_ds3, img_encode)  # B,640,256,256
